        ...
        <tr>
                        ...
                        <td style="width: 10%;">
                            <div class="form-check" style="cursor:not-allowed;">
                                <input class="form-check-input" type="radio" name="test1" id="flexRadioDefault1" value="${data.部位名稱}" disabled>
                        ...
                        <td style="width: 10%; color:#8C8C8C;">${data.型體名稱}</td>
                        <td style="width: 35%;color:#8C8C8C;">${data.材料}</td>
                        <td style="width: 10%; color:#8C8C8C; text-align: center;">${data.本批數量全}</td>
                        <td style="width: 10%;color:#8C8C8C; text-align: center;">${data.單位}</td>
        ...
        <tr>
                        ...
                        <td style="width: 10%;">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="test1" id="flexRadioDefault1" value="${data.部位名稱}" onchange="getbuttonGroupdispatchsize()">
                        ...
                        <td style="width: 10%;">${data.型體名稱}</td>
                        <td style="width: 35%;">${data.材料}</td>
                        <td style="width: 10%; text-align: center;">${data.本批數量全}</td>
                        <td style="width: 10%; text-align: center;">${data.單位}</td>
                        <td style="width: 25%;">
                        <div class="container" >
                    <div class="row">
                        <div class="col-sm-11" style="padding-left:0px;">
...
function getGroupdispatchsizeList(data) {
    ...
    if (data.數量 == 0) {
        ...
        var content3 =
            `
          <th  class="fileDiv1" scope="col"id="numo"style="width:100px;color:#888888; cursor: not-allowed;" >${data.數量}</th>
