    ...
    <div class="tab-content" id="${data.製令單號}">
        ...
        <table class="table">
                    ...
                    <td style="width: 25%; padding-left: 30px" >
                        <a href="HighFrequencyDispatchSystem.html?orderNumber=${data.製令單號}" style="text-decoration:none;">
                            <button type="button" class="btn btn-outline-dark" >進入派工畫面</button>
                        </a>

                        <a href="HighFrequencyDispatchList.html?workorderNumber=${data.製令單號}" style="text-decoration:none;">
