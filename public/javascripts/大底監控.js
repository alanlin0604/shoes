...
function newList(data){
    ...
    <div class="tab-content" id="${data.製令單號}">
        ...
        <table class="table">
                    ...
                    <td style="width: 10%; text-align: center;">${data.大底編號}</td>
                    <td style="width: 20%; text-align: center;">${time1}</td>
                    <td style="width: 20%; text-align: center;">${time2}</td>
                    ...
                    <td style="width: 30%; text-align: center;" >
                        <a href="大底監控2.html?workorderNumber=${data.製令單號}" style="text-decoration:none;">
...
function getList(){ //顯示內容
    $.get('http://' + ip + '/api/getoutsolemonitor',function(data,status){
