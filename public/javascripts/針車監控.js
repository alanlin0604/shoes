...
function newList(data){
    ...
    <div class="tab-content" id="${data.製令單號}">
        ...
        <table class="table">
                    ...
                    <td style="width: 10%; text-align: center;">${data.楦頭編號}</td>
                    ...
                    <td style="width: 30%; text-align: center;" >
                        <a href="針車監控2.html?workorderNumber=${data.製令單號}" style="text-decoration:none;">
...
function getList(){ //顯示內容
    $.get('http://' + ip + '/api/getsewingmonitor',function(data,status){
