...
function newList(data){
    ...
    var time2 = new Date(data.上次編輯時間).format("yyyy-MM-dd hh:mm:ss");
    ...
    <div class="tab-content" id="${data.製令單號}">
        ...
        <table class="table">
                    ...
                    <td style="width: 15%; text-align: center;">${data.楦頭編號}</td>
                    ...
                    <td style="width: 20%; text-align: center;" >
                        <a href="針車系統.html?s=${data.製令單號}" style="text-decoration:none;">
                            <button type="button" class="btn btn-outline-dark" >進入派工畫面</button>
                        </a>

                        <a href="針車派工.html?workorderNumber=${data.製令單號}" style="text-decoration:none;">
...
function getList(){ //顯示內容
    $.get('http://' + ip + '/api/getsewingPercent',function(data,status){
